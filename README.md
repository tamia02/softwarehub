...
| `src/app/globals.css` | Design tokens + measured type scale (outlined-pill system: 2px outlines, offset layers, 22/30px radii, cream panels); Bricolage Grotesque + Caveat; change `--brand-*` here |
