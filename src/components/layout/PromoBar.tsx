...
export function PromoBar() {
  ...
  if (!open) return null;
  return (
    <div className="anim-promo-in relative z-50 flex min-h-[40px] items-center justify-center border-b-2 border-ink-line bg-accent-soft px-12 text-center">
      <Link href="/home#pool" className="group inline-flex items-center gap-1.5 text-[14px] font-bold leading-[1.05] text-ink-line hover:text-accent-2">
